      ...
      <div className="relative h-[600px]">
        ...
        <div className="relative container mx-auto px-4 h-full flex items-center">
          <div className="text-white max-w-2xl">
            <h1 className="text-5xl font-bold mb-6">Transform Your Scrap into Value</h1>
            <p className="text-xl mb-8">Join the sustainable revolution. We make recycling and scrap management easy, efficient, and profitable for everyone.</p>
